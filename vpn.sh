...
wget -O /etc/openvpn/easy-rsa/vars "https://raw.githubusercontent.com/alamyazid/AutoScriptSSH/main/vars.conf"
...
# install openvpn
wget -O /etc/openvpn/vpn.zip "https://github.com/alamyazid/AutoScriptSSH/raw/main/vpn.zip"
cd /etc/openvpn/
unzip vpn.zip
rm -f vpn.zip
cd
...
mkdir clientconfig
cp /etc/openvpn/{TuanYz.crt,Borneo.key,ca.crt,ta.key} clientconfig/
cd clientconfig
