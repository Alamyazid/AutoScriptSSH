...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "https://raw.githubusercontent.com/alamyazid/AutoScriptSSH/main/ssrmu.sh"
...
Install_SSR
wget -O /usr/bin/ssr https://raw.githubusercontent.com/alamyazid/AutoScriptSSH/main/ssrmu.sh && chmod +x /usr/bin/ssr
wget -O /usr/bin/addssr https://raw.githubusercontent.com/alamyazid/AutoScriptSSH/main/addssr.sh && chmod +x /usr/bin/addssr
wget -O /usr/bin/delssr https://raw.githubusercontent.com/alamyazid/AutoScriptSSH/main/delssr.sh && chmod +x /usr/bin/delssr
wget -O /usr/bin/xp-ssr https://raw.githubusercontent.com/alamyazid/AutoScriptSSH/main/xp-ssr.sh && chmod +x /usr/bin/xp-ssr
wget -O /usr/bin/renewssr https://raw.githubusercontent.com/alamyazid/AutoScriptSSH/main/renewssr.sh && chmod +x /usr/bin/renewssr
